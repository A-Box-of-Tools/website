...
import{PdfWriter,num,textString,PT_PER_MM}from'./pdf-page-writer.js?v=39a464ea0b';
import{HEADINGS,LEDGER_HEADINGS,ledgerRows,rowsFor}from'./example-statement.js?v=39a464ea0b';
