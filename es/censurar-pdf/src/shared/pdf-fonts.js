...
import{base14Widths,encodingByName,glyphText,STANDARD,WIN_ANSI}from'./pdf-base14.js?v=c069f21c3a';
import{lex}from'./pdf-content.js?v=c069f21c3a';
import{decodeStream}from'./pdf-filters.js?v=c069f21c3a';
import{Name,PdfStream,PdfString}from'./pdf-objects.js?v=c069f21c3a';
const UNITS=1000;
