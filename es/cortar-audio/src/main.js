...
import{phrase}from'./shared/phrases.js?v=0caa7fed7b';
import{sizeText}from'./shared/format.js?v=0caa7fed7b';
import{messageBox}from'./shared/message-box.js?v=0caa7fed7b';
import{wireFilePicker}from'./shared/file-picker.js?v=0caa7fed7b';
import{decodeAudio,UnreadableFile}from'./shared/audio-decode.js?v=0caa7fed7b';
import{
formatDuration,openSegment,readTimestamps,segmentRanges,totalCaptured,
writeTimestamps,
}from'./segments.js?v=0caa7fed7b';
import{Timeline,formatTime,parseTime}from'./timeline.js?v=0caa7fed7b';
import{
invertRanges,isUntouched,planSections,sectionFrames,totalSeconds,trim,
}from'./trim.js?v=0caa7fed7b';
import{writeWav,wavSize}from'./shared/wav.js?v=0caa7fed7b';
import{drawWaveform,summarise}from'./waveform.js?v=0caa7fed7b';
import{makeExample}from'./example.js?v=0caa7fed7b';
