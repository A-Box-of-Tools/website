...
import{base14Widths,encodingByName,glyphText,STANDARD,WIN_ANSI}from'./pdf-base14.js?v=d4c7e8c12a';
import{lex}from'./pdf-content.js?v=d4c7e8c12a';
import{decodeStream}from'./pdf-filters.js?v=d4c7e8c12a';
import{Name,PdfStream,PdfString}from'./pdf-objects.js?v=d4c7e8c12a';
const UNITS=1000;
