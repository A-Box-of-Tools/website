...
import{clipPainter}from'./example-video.js?v=2edd1cacc6';
import{exampleAudio}from'./example-audio.js?v=2edd1cacc6';
import{Mp4Writer,avcSampleEntry}from'./mp4-writer.js?v=2edd1cacc6';
import{mp4aSampleEntry}from'./aac.js?v=2edd1cacc6';
