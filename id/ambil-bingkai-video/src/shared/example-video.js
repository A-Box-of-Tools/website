...
import{drawPhoto}from'./example-photo.js?v=fafbfb9d3b';
import{pickH264Codec}from'./video-support.js?v=fafbfb9d3b';
import{Mp4Muxer}from'./mp4-muxer.js?v=fafbfb9d3b';
const BREATH=24;
function turn(){
