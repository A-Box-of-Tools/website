...
import{drawPhoto}from'./example-photo.js?v=9cc033f2b0';
import{pickH264Codec}from'./video-support.js?v=9cc033f2b0';
import{Mp4Muxer}from'./mp4-muxer.js?v=9cc033f2b0';
const BREATH=24;
function turn(){
