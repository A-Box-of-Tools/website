...
import{phrase}from'./shared/phrases.js?v=ad2e466ee1';
import{messageBox}from'./shared/message-box.js?v=ad2e466ee1';
import{readingLabel,wireFilePicker}from'./shared/file-picker.js?v=ad2e466ee1';
import{makeZip}from'./shared/zip.js?v=ad2e466ee1';
import{WORKING_EDGE,findPageQuad}from'./detect.js?v=ad2e466ee1';
import{
clampPoint,copyQuad,orderCorners,outputSize,pageAspect,scaleQuad,wholeFrame,
}from'./geometry.js?v=ad2e466ee1';
import{turnQuad,warpPage}from'./warp.js?v=ad2e466ee1';
import{cleanPage}from'./clean.js?v=ad2e466ee1';
import{encodeImage,encodePage}from'./encode.js?v=ad2e466ee1';
import{buildDocument}from'./document.js?v=ad2e466ee1';
import{
coverage,matchPaper,outName,pageName,ratioText,scanQuality,sizeText,stemOf,
}from'./pages.js?v=ad2e466ee1';
import{Corners}from'./stage.js?v=ad2e466ee1';
import{makeExample}from'./example.js?v=ad2e466ee1';
