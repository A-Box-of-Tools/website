...
import{phrase}from'./shared/phrases.js?v=62fe854ae1';
import{downloadLink}from'./shared/download.js?v=62fe854ae1';
import{messageBox}from'./shared/message-box.js?v=62fe854ae1';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=62fe854ae1';
import{compareText,alignRows,diffWords,formatUnified}from'./diff.js?v=62fe854ae1';
import{SAMPLES}from'./samples.js?v=62fe854ae1';
