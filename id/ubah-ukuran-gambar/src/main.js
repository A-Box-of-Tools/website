...
import{phrase}from'./shared/phrases.js?v=ab0603b847';
import{measureImage}from'./shared/media.js?v=ab0603b847';
import{saveBlob}from'./shared/download.js?v=ab0603b847';
import{messageBox}from'./shared/message-box.js?v=ab0603b847';
import{
decode,encodableTypes,keepFormat,release,render as renderImage,
FORMATS,JPEG,PNG,WEBP,READABLE,
}from'./codecs.js?v=ab0603b847';
import{
fromFractions,isUntouched,parseRatio,plan,ratioCrop,toFractions,wholeOf,
}from'./geometry.js?v=ab0603b847';
import{Cropper}from'./shared/cropper.js?v=ab0603b847';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=ab0603b847';
import{
bytes,change as changeOf,countOf as imageCount,describePlan as planText,
dimensions,outName,scaleText,
}from'./files.js?v=ab0603b847';
import{makeZip}from'./shared/zip.js?v=ab0603b847';
import{makeExample}from'./example.js?v=ab0603b847';
