...
import*as jpeg from'./jpeg.js?v=8978bafeaa';
import*as png from'./png.js?v=8978bafeaa';
import*as webp from'./webp.js?v=8978bafeaa';
import{parseExif,serializeExif}from'./tiff.js?v=8978bafeaa';
