 ...
 * feature still works, which no design that uploaded your codes and the text in them could manage.
 *
...
const CACHE_NAME = 'qr-barcode-d70d22fba7';

const ASSETS = [
  './',
  'index.html',
  'styles.css?v=f5031dd656',
  'src/barcode.js',
  'src/code128.js',
  'src/gf256.js',
  'src/main.js',
