...
import{ltr,phrase}from'./shared/phrases.js?v=0ded1c6853';
import{messageBox}from'./shared/message-box.js?v=0ded1c6853';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=0ded1c6853';
import{sizeText}from'./shared/format.js?v=0ded1c6853';
import{NotAPdfError,PdfDocument}from'./shared/pdf-reader.js?v=0ded1c6853';
import{stripMetadata,writeDocument}from'./shared/pdf-writer.js?v=0ded1c6853';
import{standardSecurity,WrongPasswordError}from'./shared/pdf-crypt.js?v=0ded1c6853';
import{refusedIn}from'./shared/pdf-permissions.js?v=0ded1c6853';
import{outName,pages,scheme,strength}from'./format.js?v=0ded1c6853';
import{makeExample}from'./example.js?v=0ded1c6853';
