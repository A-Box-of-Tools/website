...
import{FileWindow}from'./shared/mp4-reader.js?v=079d7068b5';
import{Mp4Writer,VIDEO_TIMESCALE}from'./mp4.js?v=079d7068b5';
import{drawCropped}from'./draw.js?v=079d7068b5';
import{pickH264Codec}from'./shared/video-support.js?v=079d7068b5';
import{decoderConfig,averageFps,micros,settle}from'./shared/webcodecs.js?v=079d7068b5';
import{throwIfAborted,said}from'./shared/errors.js?v=079d7068b5';
