...
import{takeInventory}from'./inventory.js?v=1986656815';
import{
decodeImage,findImages,reencode,replaceImage,SKIP,
}from'./images.js?v=1986656815';
import{effectiveDpi,measurePlacements}from'./placements.js?v=1986656815';
import{PdfDocument}from'./shared/pdf-reader.js?v=1986656815';
import{stripMetadata,writeDocument}from'./shared/pdf-writer.js?v=1986656815';
