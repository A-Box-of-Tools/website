...
import{phrase,ltr}from'./shared/phrases.js?v=a4518e3bf8';
import{sizeText,durationText}from'./shared/format.js?v=a4518e3bf8';
import{messageBox}from'./shared/message-box.js?v=a4518e3bf8';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=a4518e3bf8';
import{
loadImages,releaseItem,sortItems,moveItem,decodeFull,
clampDelay,DEFAULT_DELAY,MIN_DELAY,MAX_DELAY,
}from'./images.js?v=a4518e3bf8';
import{drawFrame,resolveOutputSize,MAX_SIDE}from'./compose.js?v=a4518e3bf8';
import{encodeGif,loopValue}from'./encode.js?v=a4518e3bf8';
import{makeExample}from'./example.js?v=a4518e3bf8';
