...
import{phrase}from'./shared/phrases.js?v=bedd2a51a6';
import{classSizes,generate,phraseChoices,SYMBOL_SETS}from'./generate.js?v=bedd2a51a6';
import{
bits,crackTime,passphraseSpace,passwordSpace,rating,scientific,
}from'./strength.js?v=bedd2a51a6';
import{wordlist}from'./wordlist.js?v=bedd2a51a6';
