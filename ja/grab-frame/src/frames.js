...
import{FileWindow}from'./shared/mp4-reader.js?v=fafbfb9d3b';
import{drawUpright}from'./draw.js?v=fafbfb9d3b';
import{micros}from'./shared/webcodecs.js?v=fafbfb9d3b';
import{throwIfAborted}from'./shared/errors.js?v=fafbfb9d3b';
