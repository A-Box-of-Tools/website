...
import{phrase}from'./shared/phrases.js?v=b1f87d6c0c';
import{messageBox}from'./shared/message-box.js?v=b1f87d6c0c';
import{
SPECS,backgroundOf,pixelLabel,portalBytes,portalPixels,printLabel,
specById,specsByCountry,trim,withCustom,
}from'./specs.js?v=b1f87d6c0c';
import{
fitFrame,frameAspect,guideLines,measure,passes,printPixels,resampling,
}from'./geometry.js?v=b1f87d6c0c';
import{PAPERS,bestSheet,describeSheet,paperById}from'./sheet.js?v=b1f87d6c0c';
import{
checkBackground,checkSignature,readBackground,readSignature,
}from'./background.js?v=b1f87d6c0c';
import{
decode,drawCrop,drawSheet,encodePrint,encodeToBand,free,release,
samplePixels,sizeText,
}from'./encode.js?v=b1f87d6c0c';
import{WORKING_EDGE,findMarks}from'./detect.js?v=b1f87d6c0c';
import{Cropper}from'./cropper.js?v=b1f87d6c0c';
import{Marks}from'./marks.js?v=b1f87d6c0c';
import{
bandText,centreText,outName,readyText,resamplingText,statusClass,stemOf,
tiltText,verdictText,
}from'./files.js?v=b1f87d6c0c';
import{readingLabel,wireFilePicker}from'./shared/file-picker.js?v=b1f87d6c0c';
import{makeExample}from'./example.js?v=b1f87d6c0c';
