...
import {
  ...
  estimate, isMeasured, logPolar, logSpectrum, phaseCorrelate, rotateScale,
  window2d,
} from '../../tools/stack-images/src/align.js';
import {
  field, octave, scene, lowScene, otherScene, gradient, otherLow, diagonal,
  horizontal, starField, noisy, jpeg, circularShift, GATE_SIZE, gateFixture,
  eightBit, letterbox, surveyBox, WHOLE_SQUARE, clip, lit,
 ...
 *
 * The fixtures these read - the scenes, the 256 square, the letterbox and
 * the black level - are in stack-images-fixtures.js, with the note on what
 * each was calibrated against. The number beside each assertion is what this
 * seed measured; the constants were chosen over ten seeds, and the ranges are
 * in the comments on P_MAX and N_MAX in align.js.
 */
