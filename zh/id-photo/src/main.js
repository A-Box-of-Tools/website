...
import{ltr,phrase}from'./shared/phrases.js?v=f42854845d';
import{messageBox}from'./shared/message-box.js?v=f42854845d';
import{
SPECS,backgroundOf,pixelLabel,portalBytes,portalPixels,printLabel,
specById,specsByCountry,trim,withCustom,
}from'./specs.js?v=f42854845d';
import{
fitFrame,frameAspect,guideLines,measure,passes,printPixels,resampling,
}from'./geometry.js?v=f42854845d';
import{PAPERS,bestSheet,describeSheet,paperById}from'./sheet.js?v=f42854845d';
import{
checkBackground,checkSignature,readBackground,readSignature,
}from'./background.js?v=f42854845d';
import{
decode,drawCrop,drawSheet,encodePrint,encodeToBand,free,release,
samplePixels,sizeText,
}from'./encode.js?v=f42854845d';
import{WORKING_EDGE,findMarks}from'./detect.js?v=f42854845d';
import{Cropper}from'./cropper.js?v=f42854845d';
import{Marks}from'./marks.js?v=f42854845d';
import{
bandText,centreText,outName,readyText,resamplingText,statusClass,stemOf,
tiltText,verdictText,
}from'./files.js?v=f42854845d';
import{readingLabel,wireFilePicker}from'./shared/file-picker.js?v=f42854845d';
import{makeExample}from'./example.js?v=f42854845d';
import{readRequirements}from'./requirements.js?v=f42854845d';
