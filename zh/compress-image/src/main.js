...
import{phrase}from'./shared/phrases.js?v=854d50ac27';
import{measureImage}from'./shared/media.js?v=854d50ac27';
import{saveBlob}from'./shared/download.js?v=854d50ac27';
import{messageBox}from'./shared/message-box.js?v=854d50ac27';
import{
decode,encodableTypes,release,FORMATS,JPEG,PNG,WEBP,READABLE,
}from'./codecs.js?v=854d50ac27';
import{
fitToTarget,keepFormat,alternativeFormat,QUALITY_FLOOR,
}from'./compress.js?v=854d50ac27';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=854d50ac27';
import{compare,hasTransparency}from'./measure.js?v=854d50ac27';
import{
bytes,targetBytes,dimensions,outName,change,matchText,psnrText,
}from'./files.js?v=854d50ac27';
import{makeZip}from'./shared/zip.js?v=854d50ac27';
import{makeExample}from'./example.js?v=854d50ac27';
