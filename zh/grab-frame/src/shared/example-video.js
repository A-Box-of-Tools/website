...
import{drawPhoto}from'./example-photo.js?v=daa2b51fcb';
import{pickH264Codec}from'./video-support.js?v=daa2b51fcb';
import{Mp4Muxer}from'./mp4-muxer.js?v=daa2b51fcb';
const BREATH=24;
function turn(){
