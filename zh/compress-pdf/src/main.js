...
import{phrase}from'./shared/phrases.js?v=3be8c4c8c2';
import{messageBox}from'./shared/message-box.js?v=3be8c4c8c2';
import{
compressDocument,describeSettings,PRESETS,
}from'./compress.js?v=3be8c4c8c2';
import{takeInventory,verdict}from'./inventory.js?v=3be8c4c8c2';
import{EncryptedPdfError,NotAPdfError,PdfDocument}from'./shared/pdf-reader.js?v=3be8c4c8c2';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=3be8c4c8c2';
import{makeExample}from'./example.js?v=3be8c4c8c2';
import{
bytes as humanBytes,change,count,dimensions,dpi,outName,share,
}from'./format.js?v=3be8c4c8c2';
