...
import{isName,PdfStream,Ref}from'./shared/pdf-objects.js?v=3be8c4c8c2';
import{scanObjectHeaders}from'./shared/pdf-reader.js?v=3be8c4c8c2';
import{reachable}from'./shared/pdf-writer.js?v=3be8c4c8c2';
const GROUPS=[
