...
import{phrase}from'./shared/phrases.js?v=b4c21a433b';
import{messageBox}from'./shared/message-box.js?v=b4c21a433b';
import{writeIco,dibEntry,readIcoDirectory}from'./ico.js?v=b4c21a433b';
import{writeIcns,readIcnsElements,ICNS_TYPES,ICNS_SIZES}from'./icns.js?v=b4c21a433b';
import{PRESETS,SIZES,WHY,presetById,storageFor,dibBytes}from'./sizes.js?v=b4c21a433b';
import{decode,release,square,pixels,png,FIT,NOMINAL_VECTOR}from'./render.js?v=b4c21a433b';
import{PACK_IMAGES,manifest,browserConfig,headSnippet,readme}from'./pack.js?v=b4c21a433b';
import{
bytes,dimensions,countOf as count,iconName,folderFor,
describe as describeSizes,listOf as joinList,
}from'./files.js?v=b4c21a433b';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=b4c21a433b';
import{makeZip}from'./shared/zip.js?v=b4c21a433b';
import{makeExample}from'./example.js?v=b4c21a433b';
