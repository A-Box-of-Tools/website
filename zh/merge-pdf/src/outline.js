...
import{isGoTo,resolveDestination}from'./dests.js?v=7117203ba2';
import{decodeText}from'./shared/pdf-pages.js?v=7117203ba2';
import{name,PdfString,Ref}from'./shared/pdf-objects.js?v=7117203ba2';
