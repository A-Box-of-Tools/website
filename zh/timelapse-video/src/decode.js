...
import{FileWindow}from'./shared/mp4-reader.js?v=4d581c9838';
import{decodeRuns}from'./plan.js?v=4d581c9838';
import{drawScaled,frameCanvas}from'./shared/frame-canvas.js?v=4d581c9838';
import{decoderConfig,settle}from'./shared/webcodecs.js?v=4d581c9838';
import{throwIfAborted}from'./shared/errors.js?v=4d581c9838';
class Sampler{
#times;
#canvas;
#write;
