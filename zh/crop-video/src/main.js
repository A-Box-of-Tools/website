...
import{phrase,fill}from'./shared/phrases.js?v=f058e885be';
import{decoderConfig,averageFps}from'./shared/webcodecs.js?v=f058e885be';
import{sizeText,durationText}from'./shared/format.js?v=f058e885be';
import{openInPlayer}from'./shared/media.js?v=f058e885be';
import{messageBox}from'./shared/message-box.js?v=f058e885be';
import{wireFilePicker}from'./shared/file-picker.js?v=f058e885be';
import{demux,UnsupportedFile}from'./shared/mp4-reader.js?v=f058e885be';
import{cropExact,grabFrame}from'./transcode.js?v=f058e885be';
import{cropByRecording}from'./record.js?v=f058e885be';
import{Cropper}from'./shared/cropper.js?v=f058e885be';
import{hasWebCodecs,hasMediaRecorder,canDecode}from'./shared/video-support.js?v=f058e885be';
import{makeExample}from'./example.js?v=f058e885be';
