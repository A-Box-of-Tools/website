...
import{phrase}from'./shared/phrases.js?v=659fb2aba4';
import{saveBlob}from'./shared/download.js?v=659fb2aba4';
import{SHAPES,objectShape,shapeOf}from'./figures.js?v=659fb2aba4';
import{FONT,chartSvg,isDark}from'./chart.js?v=659fb2aba4';
import{format,formatBoth,parseHeight,toInput}from'./units.js?v=659fb2aba4';
import{svgBlob,svgToPng}from'./save.js?v=659fb2aba4';
import{LIMITS,importSvg}from'./import-svg.js?v=659fb2aba4';
import{IMAGE_LIMITS,fit,imageMarkup,nameFromFile}from'./import-image.js?v=659fb2aba4';
