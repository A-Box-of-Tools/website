...
import{phrase,fill,ltr}from'./shared/phrases.js?v=ea81adbdb0';
import{messageBox}from'./shared/message-box.js?v=ea81adbdb0';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=ea81adbdb0';
import{DISPOSALS,NotAGif,frameData,parseGif}from'./gif.js?v=ea81adbdb0';
import{lzwDecode}from'./lzw.js?v=ea81adbdb0';
import{Compositor,duration,isFullCanvas,paintFrame}from'./frames.js?v=ea81adbdb0';
import{budget,distinctColors,paletteWaste}from'./budget.js?v=ea81adbdb0';
import{findings}from'./findings.js?v=ea81adbdb0';
import{report}from'./report.js?v=ea81adbdb0';
import{clock,count,delay,exact,fileSize,hex,percent,plural,rate}from'./format.js?v=ea81adbdb0';
import{makeExample}from'./example.js?v=ea81adbdb0';
