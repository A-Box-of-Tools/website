...
import{phrase,ltr}from'./shared/phrases.js?v=2edd1cacc6';
import{sizeText,durationText}from'./shared/format.js?v=2edd1cacc6';
import{openInPlayer}from'./shared/media.js?v=2edd1cacc6';
import{messageBox}from'./shared/message-box.js?v=2edd1cacc6';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=2edd1cacc6';
import{demux,UnsupportedFile}from'./shared/mp4-reader.js?v=2edd1cacc6';
import{joinByCopy,estimateJoinCopy}from'./copy.js?v=2edd1cacc6';
import{decoderConfig,averageFps}from'./shared/webcodecs.js?v=2edd1cacc6';
import{joinExact,grabFrame,chooseJoinBitrate}from'./transcode.js?v=2edd1cacc6';
import{trimByRecording,estimateRecording}from'./record.js?v=2edd1cacc6';
import{joinability,outputFrame}from'./clips.js?v=2edd1cacc6';
import{fittedBox}from'./draw.js?v=2edd1cacc6';
import{Timeline,formatTime,parseTime}from'./timeline.js?v=2edd1cacc6';
import{
openSegment,readTimestamps,segmentRanges,totalCaptured,writeTimestamps,
}from'./segments.js?v=2edd1cacc6';
import{keyframeTimes,keyframeBefore,invertRanges,totalSeconds}from'./ranges.js?v=2edd1cacc6';
import{hasWebCodecs,hasMediaRecorder,canDecode}from'./shared/video-support.js?v=2edd1cacc6';
import{makeExample}from'./example.js?v=2edd1cacc6';
