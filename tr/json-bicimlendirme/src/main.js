...
import{phrase,fill}from'./shared/phrases.js?v=77ae3be0df';
import{sizeText}from'./shared/format.js?v=77ae3be0df';
import{downloadLink}from'./shared/download.js?v=77ae3be0df';
import{messageBox}from'./shared/message-box.js?v=77ae3be0df';
import{wireFilePicker}from'./shared/file-picker.js?v=77ae3be0df';
import{LANGUAGES,languageById,formatText,detectLanguage}from'./format.js?v=77ae3be0df';
import{CONVERSIONS,conversionById}from'./convert.js?v=77ae3be0df';
import{SAMPLES}from'./samples.js?v=77ae3be0df';
