...
import{DISPOSALS}from'./gif.js?v=ea81adbdb0';
import{duration,isFullCanvas}from'./frames.js?v=ea81adbdb0';
import{clock,count,delay,exact,fileSize,hex,percent,rate}from'./format.js?v=ea81adbdb0';
