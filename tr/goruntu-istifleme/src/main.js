...
import{phrase}from'./shared/phrases.js?v=a2fc99e04f';
import{messageBox}from'./shared/message-box.js?v=a2fc99e04f';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=a2fc99e04f';
import{SCALES,outputSize,planRun,scaleThatFits}from'./plan.js?v=a2fc99e04f';
import{makeExample}from'./example.js?v=a2fc99e04f';
...
try{
worker=new Worker(new URL('./worker.js?v=a2fc99e04f',import.meta.url),{type:'module'});
...
local=import('./pipeline.js?v=a2fc99e04f');
}
}
