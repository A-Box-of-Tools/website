...
import{phrase}from'./shared/phrases.js?v=d4c7e8c12a';
import{messageBox}from'./shared/message-box.js?v=d4c7e8c12a';
import{downloadLink}from'./shared/download.js?v=d4c7e8c12a';
import{sizeText}from'./shared/format.js?v=d4c7e8c12a';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=d4c7e8c12a';
import{EncryptedPdfError,NotAPdfError,PdfDocument}from'./shared/pdf-reader.js?v=d4c7e8c12a';
import{pagesOf,readPage}from'./shared/pdf-text.js?v=d4c7e8c12a';
import{pageRuns}from'./layout.js?v=d4c7e8c12a';
import{cellsOf,findTables}from'./tables.js?v=d4c7e8c12a';
import{buildTable}from'./rows.js?v=d4c7e8c12a';
import{checkBalance}from'./check.js?v=d4c7e8c12a';
import{columnLetter,toCsv}from'./csv.js?v=d4c7e8c12a';
import{
dateOrder,decimalMark,formatAmount,hasAmbiguousDates,looksNumeric,parseAmount,
parseDate,
}from'./values.js?v=d4c7e8c12a';
import{makeExample}from'./example.js?v=d4c7e8c12a';
