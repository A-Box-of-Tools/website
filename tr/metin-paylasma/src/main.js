...
import{phrase}from'./shared/phrases.js?v=28fe0d3c9c';
import{renderMarkdown}from'./markdown.js?v=28fe0d3c9c';
import{CODE_PATTERN,formatSize,makeCode,normalize}from'./names.js?v=28fe0d3c9c';
