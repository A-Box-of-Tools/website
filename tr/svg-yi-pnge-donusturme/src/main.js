...
import{phrase,fill}from'./shared/phrases.js?v=0c9c52952c';
import{messageBox}from'./shared/message-box.js?v=0c9c52952c';
import{
decodeSvgText,intrinsicSize,looksLikeSvg,
}from'./svg.js?v=0c9c52952c';
import{
MODES,atDensity,checkLimits,describePlan,planSize,times,
}from'./sizing.js?v=0c9c52952c';
import{
FORMATS,JPEG,PNG,WEBP,draw,encodableTypes,loadAt,rasterize,
}from'./render.js?v=0c9c52952c';
import{
bytes as humanBytes,dimensions,outName,sourceKey,uniqueNames,
}from'./files.js?v=0c9c52952c';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=0c9c52952c';
import{makeZip}from'./shared/zip.js?v=0c9c52952c';
import{makeExample}from'./example.js?v=0c9c52952c';
