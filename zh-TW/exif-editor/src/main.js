...
import{phrase,ltr}from'./shared/phrases.js?v=8978bafeaa';
import{measureImage}from'./shared/media.js?v=8978bafeaa';
import{saveBlob}from'./shared/download.js?v=8978bafeaa';
import{messageBox}from'./shared/message-box.js?v=8978bafeaa';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=8978bafeaa';
import{makeZip}from'./shared/zip.js?v=8978bafeaa';
import{readImage,readBytes,serialize,exifBytes,outputType,KIND_NAMES}from'./container.js?v=8978bafeaa';
import{serializeExif,setEntryValue,createEntry,TYPE}from'./tiff.js?v=8978bafeaa';
import{describeTag}from'./tags.js?v=8978bafeaa';
import{makeExample}from'./example.js?v=8978bafeaa';
import{
formatValue,readPosition,buildFindings,badges,bytes as humanBytes,
countTags,metadataSize,hasMetadata,tagGroups,
}from'./report.js?v=8978bafeaa';
