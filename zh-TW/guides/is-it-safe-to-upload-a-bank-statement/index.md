...
[開啟PDF 轉 CSV](https://abox.tools/zh-TW/pdf-to-csv/): 把 PDF 裡的每一張表都找出來，變成表格軟體打得開的一行一行。

最後更新 9 September 2026
