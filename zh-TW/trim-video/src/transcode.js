...
import{FileWindow}from'./shared/mp4-reader.js?v=2edd1cacc6';
import{Mp4Writer,MOVIE_TIMESCALE,avcSampleEntry}from'./shared/mp4-writer.js?v=2edd1cacc6';
import{planRanges}from'./ranges.js?v=2edd1cacc6';
import{closeDurations,audioSamplesFor}from'./copy.js?v=2edd1cacc6';
import{encodeJoinedAudio,targetAudioFormat}from'./audio.js?v=2edd1cacc6';
import{drawFitted}from'./draw.js?v=2edd1cacc6';
import{pickH264Codec}from'./shared/video-support.js?v=2edd1cacc6';
import{decoderConfig,averageFps,micros,settle}from'./shared/webcodecs.js?v=2edd1cacc6';
import{throwIfAborted}from'./shared/errors.js?v=2edd1cacc6';
