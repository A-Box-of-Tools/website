...
import{phrase,fill}from'./shared/phrases.js?v=ae6fb8ae23';
import{decoderConfig,averageFps}from'./shared/webcodecs.js?v=ae6fb8ae23';
import{sizeText,durationText}from'./shared/format.js?v=ae6fb8ae23';
import{openInPlayer}from'./shared/media.js?v=ae6fb8ae23';
import{messageBox}from'./shared/message-box.js?v=ae6fb8ae23';
import{wireFilePicker}from'./shared/file-picker.js?v=ae6fb8ae23';
import{demux,UnsupportedFile}from'./shared/mp4-reader.js?v=ae6fb8ae23';
import{timelapseByDecoding,previewFrame}from'./decode.js?v=ae6fb8ae23';
import{timelapseByPlaying}from'./playback.js?v=ae6fb8ae23';
import{TimelapseWriter}from'./encode.js?v=ae6fb8ae23';
import{hasEncoder,hasWebCodecs,canDecode,pickH264Codec}from'./shared/video-support.js?v=ae6fb8ae23';
import{
MIN_FRAMES,
...
}from'./plan.js?v=ae6fb8ae23';
import{said}from'./shared/errors.js?v=ae6fb8ae23';
import{makeExample}from'./example.js?v=ae6fb8ae23';
