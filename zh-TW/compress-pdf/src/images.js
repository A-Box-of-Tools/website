...
import{decodeStream,deflate,filterNames}from'./shared/pdf-filters.js?v=1986656815';
import{isName,name,Name,PdfStream,Ref}from'./shared/pdf-objects.js?v=1986656815';
const TINY=4*1024;
export const SKIP={
jpx:'kept.jpx',
jbig2:'kept.jbig2',
