...
import{phrase}from'./shared/phrases.js?v=f8965a767b';
import{saveBlob}from'./shared/download.js?v=f8965a767b';
import{KINDS,compose,missing}from'./payload.js?v=f8965a767b';
import{makeQr}from'./shared/qr.js?v=f8965a767b';
import{capacityFor}from'./shared/qr-encode.js?v=f8965a767b';
import{SYMBOLOGIES,makeBarcode}from'./barcode.js?v=f8965a767b';
import{
barcodeSvg,qrSvg,sizeOfSvg,svgToPng,
}from'./render.js?v=f8965a767b';
