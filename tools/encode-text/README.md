...
*Base64, URLs, entities, hex and escapes — both ways, on your own machine.*  ·  lives at `/encode-text/`  ·  [all tools](../)  ·  [how the site is built](../../README.md)

This page, [`format-json`](../format-json/) and [`compare-text`](../compare-text/)
