...
// here: anything that is not this origin and not on this list would be a request
// nobody asked for, and the panel says so in those words.
...
// google.com is written as a pattern because Google's measurement pixel uses the
// visitor's own country domain - www.google.ca, www.google.co.uk - and a list of
// literal hostnames turns the panel red for a visitor in the wrong country. That
// is the worst possible failure for this particular panel: the one place on the
// page meant to be checkable, saying something untrue.
const PLATFORM_HOSTS = /(^|\.)(googlesyndication\.com|doubleclick\.net|googleadservices\.com|googletagservices\.com|adtrafficquality\.google|googletagmanager\.com|google-analytics\.com|gstatic\.com|googleapis\.com|buymeacoffee\.com|cloudflareinsights\.com|google\.[a-z]{2,3}(\.[a-z]{2})?)$/;

/**
 * Report what this page has actually fetched.
 *
 * The claim on trial is not "this page is silent" - it is not silent, it carries
 * ads - but "nothing has carried your document away". It matters as much here as
 * anywhere on this site: what people photograph a page of is a passport, a
 * payslip, a lease or a form an office asked them for, and the whole photograph
 * arrives on this page before anything has been done to it.
 */
