 ...
 *
 * The two functions below are lifted from that file unchanged, so that a fix
 * to either conversion can be applied to both copies without reading around
 * it first.
 *
 * WHAT IS LOST, SAID OUT LOUD
 *
 * Neither direction is free, and a converter that pretends otherwise is where
