 ...
 *
 * A real portrait rather than a drawn one, because this tool measures a face -
 * the eye line, the chin, the crown - and there is nothing in a drawn one to
 * measure. See example-data.js for where it came from.
 */
