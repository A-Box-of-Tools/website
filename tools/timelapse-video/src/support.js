/**
 * Feature detection for the two paths a time-lapse can take.
 *
 ...
 * through. What separates them is the reading: the direct path opens the file
...
/** Everything the direct path needs: it reads the frames as well as writing them. */
