...
import{base14Widths,encodingByName,glyphText,STANDARD,WIN_ANSI}from'./pdf-base14.js?v=3b15f0586b';
import{lex}from'./pdf-content.js?v=3b15f0586b';
import{decodeStream}from'./pdf-filters.js?v=3b15f0586b';
import{Name,PdfStream,PdfString}from'./pdf-objects.js?v=3b15f0586b';
const UNITS=1000;
