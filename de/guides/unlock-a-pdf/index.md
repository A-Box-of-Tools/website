...
[PDF Unlocker öffnen](https://abox.tools/de/unlock-pdf/): Most locked PDFs need no password at all. This one says which kind you have before it touches it.

Zuletzt aktualisiert 10 September 2026

## The short answer

Open the [PDF Unlocker](https://abox.tools/de/unlock-pdf/) and drop the document in. Within a second it will tell you which of two situations you are in, and they are not close to each other:
...
In most readers you can see the detail: open the document properties and look at the Security tab, which lists every permission as Allowed or Not Allowed. The [PDF Unlocker](https://abox.tools/de/unlock-pdf/) shows the same list, and adds the thing no reader shows you — which encryption scheme the file uses, and what that scheme is worth today.
...
An unlocked document is an ordinary one, so the rest of the box works on it: [merge or split it](https://abox.tools/de/pdf-zusammenfuegen/), [make it smaller](https://abox.tools/de/pdf-verkleinern/), or [take a name out of it properly](https://abox.tools/de/pdf-schwaerzen/) — which, if the reason it was locked was that it contains something private, is very likely the next thing you actually want.
