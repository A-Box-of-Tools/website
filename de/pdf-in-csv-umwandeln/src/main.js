...
import{phrase}from'./shared/phrases.js?v=39a464ea0b';
import{messageBox}from'./shared/message-box.js?v=39a464ea0b';
import{downloadLink}from'./shared/download.js?v=39a464ea0b';
import{sizeText}from'./shared/format.js?v=39a464ea0b';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=39a464ea0b';
import{EncryptedPdfError,NotAPdfError,PdfDocument}from'./shared/pdf-reader.js?v=39a464ea0b';
import{pagesOf,readPage}from'./shared/pdf-text.js?v=39a464ea0b';
import{pageRuns}from'./layout.js?v=39a464ea0b';
import{cellsOf,findTables}from'./tables.js?v=39a464ea0b';
import{buildTable}from'./rows.js?v=39a464ea0b';
import{checkBalance}from'./check.js?v=39a464ea0b';
import{columnLetter,toCsv}from'./csv.js?v=39a464ea0b';
import{
dateOrder,decimalMark,formatAmount,hasAmbiguousDates,looksNumeric,parseAmount,
parseDate,
}from'./values.js?v=39a464ea0b';
import{makeExample}from'./example.js?v=39a464ea0b';
