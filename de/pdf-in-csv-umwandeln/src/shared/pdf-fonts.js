...
import{base14Widths,encodingByName,glyphText,STANDARD,WIN_ANSI}from'./pdf-base14.js?v=39a464ea0b';
import{lex}from'./pdf-content.js?v=39a464ea0b';
import{decodeStream}from'./pdf-filters.js?v=39a464ea0b';
import{Name,PdfStream,PdfString}from'./pdf-objects.js?v=39a464ea0b';
const UNITS=1000;
