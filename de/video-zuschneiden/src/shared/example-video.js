...
import{drawPhoto}from'./example-photo.js?v=f058e885be';
import{pickH264Codec}from'./video-support.js?v=f058e885be';
import{Mp4Muxer}from'./mp4-muxer.js?v=f058e885be';
const BREATH=24;
function turn(){
