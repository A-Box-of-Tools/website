...
import{drawPhoto}from'./example-photo.js?v=1375624944';
import{pickH264Codec}from'./video-support.js?v=1375624944';
import{Mp4Muxer}from'./mp4-muxer.js?v=1375624944';
const BREATH=24;
function turn(){
