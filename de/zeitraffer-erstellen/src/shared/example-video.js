...
import{drawPhoto}from'./example-photo.js?v=4d581c9838';
import{pickH264Codec}from'./video-support.js?v=4d581c9838';
import{Mp4Muxer}from'./mp4-muxer.js?v=4d581c9838';
const BREATH=24;
function turn(){
