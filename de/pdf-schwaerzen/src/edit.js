...
import{formatNumber,formatString,formatValue}from'./shared/pdf-content.js?v=3b15f0586b';
import{PdfString}from'./shared/pdf-objects.js?v=3b15f0586b';
import{decodeText,encodeText}from'./strings.js?v=3b15f0586b';
import{cornersOf,endOf}from'./shared/pdf-text.js?v=3b15f0586b';
