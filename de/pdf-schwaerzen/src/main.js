...
import{phrase}from'./shared/phrases.js?v=3b15f0586b';
import{messageBox}from'./shared/message-box.js?v=3b15f0586b';
import{bytes as humanBytes,outName,tally}from'./format.js?v=3b15f0586b';
import{
contextOf,FINDERS,findPattern,findTerm,glyphsIn,mergeRanges,wordsOf,
}from'./matches.js?v=3b15f0586b';
import{EncryptedPdfError,NotAPdfError,PdfDocument}from'./shared/pdf-reader.js?v=3b15f0586b';
import{redact}from'./redact.js?v=3b15f0586b';
import{pagesOf,readPage}from'./shared/pdf-text.js?v=3b15f0586b';
import{harvestAll,verify}from'./verify.js?v=3b15f0586b';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=3b15f0586b';
import{makeExample}from'./example.js?v=3b15f0586b';
