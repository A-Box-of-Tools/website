...
import{FileWindow}from'./shared/mp4-reader.js?v=c9b2d0b22a';
import{Mp4Writer,MOVIE_TIMESCALE,avcSampleEntry}from'./shared/mp4-writer.js?v=c9b2d0b22a';
import{planRanges}from'./ranges.js?v=c9b2d0b22a';
import{closeDurations,audioSamplesFor}from'./copy.js?v=c9b2d0b22a';
import{encodeJoinedAudio,targetAudioFormat}from'./audio.js?v=c9b2d0b22a';
import{drawFitted}from'./draw.js?v=c9b2d0b22a';
import{pickH264Codec}from'./shared/video-support.js?v=c9b2d0b22a';
import{decoderConfig,averageFps,micros,settle}from'./shared/webcodecs.js?v=c9b2d0b22a';
import{throwIfAborted}from'./shared/errors.js?v=c9b2d0b22a';
