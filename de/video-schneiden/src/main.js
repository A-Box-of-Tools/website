...
import{phrase,ltr}from'./shared/phrases.js?v=c9b2d0b22a';
import{sizeText,durationText}from'./shared/format.js?v=c9b2d0b22a';
import{openInPlayer}from'./shared/media.js?v=c9b2d0b22a';
import{messageBox}from'./shared/message-box.js?v=c9b2d0b22a';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=c9b2d0b22a';
import{demux,UnsupportedFile}from'./shared/mp4-reader.js?v=c9b2d0b22a';
import{joinByCopy,estimateJoinCopy}from'./copy.js?v=c9b2d0b22a';
import{decoderConfig,averageFps}from'./shared/webcodecs.js?v=c9b2d0b22a';
import{joinExact,grabFrame,chooseJoinBitrate}from'./transcode.js?v=c9b2d0b22a';
import{trimByRecording,estimateRecording}from'./record.js?v=c9b2d0b22a';
import{joinability,outputFrame}from'./clips.js?v=c9b2d0b22a';
import{fittedBox}from'./draw.js?v=c9b2d0b22a';
import{Timeline,formatTime,parseTime}from'./timeline.js?v=c9b2d0b22a';
import{
openSegment,readTimestamps,segmentRanges,totalCaptured,writeTimestamps,
}from'./segments.js?v=c9b2d0b22a';
import{keyframeTimes,keyframeBefore,invertRanges,totalSeconds}from'./ranges.js?v=c9b2d0b22a';
import{hasWebCodecs,hasMediaRecorder,canDecode}from'./shared/video-support.js?v=c9b2d0b22a';
import{makeExample}from'./example.js?v=c9b2d0b22a';
