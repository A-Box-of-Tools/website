...
import{isName,PdfStream,Ref}from'./shared/pdf-objects.js?v=1986656815';
import{scanObjectHeaders}from'./shared/pdf-reader.js?v=1986656815';
import{reachable}from'./shared/pdf-writer.js?v=1986656815';
const GROUPS=[
