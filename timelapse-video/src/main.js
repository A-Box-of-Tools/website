...
import{phrase,fill}from'./shared/phrases.js?v=4d581c9838';
import{decoderConfig,averageFps}from'./shared/webcodecs.js?v=4d581c9838';
import{sizeText,durationText}from'./shared/format.js?v=4d581c9838';
import{openInPlayer}from'./shared/media.js?v=4d581c9838';
import{messageBox}from'./shared/message-box.js?v=4d581c9838';
import{wireFilePicker}from'./shared/file-picker.js?v=4d581c9838';
import{demux,UnsupportedFile}from'./shared/mp4-reader.js?v=4d581c9838';
import{timelapseByDecoding,previewFrame}from'./decode.js?v=4d581c9838';
import{timelapseByPlaying}from'./playback.js?v=4d581c9838';
import{TimelapseWriter}from'./encode.js?v=4d581c9838';
import{hasEncoder,hasWebCodecs,canDecode,pickH264Codec}from'./shared/video-support.js?v=4d581c9838';
import{
MIN_FRAMES,
...
}from'./plan.js?v=4d581c9838';
import{said}from'./shared/errors.js?v=4d581c9838';
import{makeExample}from'./example.js?v=4d581c9838';
