...
const CACHE_PREFIX='abox:/fr/comparer-des-tailles/:';
const CACHE_NAME=CACHE_PREFIX+'57746f21a3';
const ASSETS=[
'./',
'index.html',
'index.md',
'styles.css?v=7819107254',
'manifest.json',
'src/shared/phrases.js?v=659fb2aba4',
'src/shared/trust.js?v=659fb2aba4',
'src/shared/download.js?v=659fb2aba4',
'src/chart.js?v=659fb2aba4',
'src/figures.js?v=659fb2aba4',
'src/import-image.js?v=659fb2aba4',
'src/import-svg.js?v=659fb2aba4',
'src/main.js?v=659fb2aba4',
'src/objects.js?v=659fb2aba4',
'src/save.js?v=659fb2aba4',
'src/traced.js?v=659fb2aba4',
'src/units.js?v=659fb2aba4',
'vendor/LICENSE.md',
