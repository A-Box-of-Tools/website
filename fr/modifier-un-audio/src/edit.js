...
import{reverse,applyGain,peak,dbToGain,normalizeGain}from'./effects.js?v=ef00d58da2';
import{resample,resampledLength}from'./speed.js?v=ef00d58da2';
import{stretch,stretchedLength}from'./stretch.js?v=ef00d58da2';
