...
import{phrase}from'./shared/phrases.js?v=58d20e4e48';
import{messageBox}from'./shared/message-box.js?v=58d20e4e48';
import{base64DataUri,svgDataUri}from'./encode.js?v=58d20e4e48';
import{sniff,extensionType}from'./sniff.js?v=58d20e4e48';
import{metadata}from'./metadata.js?v=58d20e4e48';
import{
SHAPES,render as renderShape,bundle,bundleName,fileName,identifiers,
}from'./shapes.js?v=58d20e4e48';
import{
bytes as humanBytes,count,overhead,verdict,metadataNote,dimensions,
}from'./files.js?v=58d20e4e48';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=58d20e4e48';
import{makeExample}from'./example.js?v=58d20e4e48';
