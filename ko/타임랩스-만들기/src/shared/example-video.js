...
import{drawPhoto}from'./example-photo.js?v=ae6fb8ae23';
import{pickH264Codec}from'./video-support.js?v=ae6fb8ae23';
import{Mp4Muxer}from'./mp4-muxer.js?v=ae6fb8ae23';
const BREATH=24;
function turn(){
