...
import{phrase}from'./shared/phrases.js?v=1986656815';
import{messageBox}from'./shared/message-box.js?v=1986656815';
import{
compressDocument,describeSettings,PRESETS,
}from'./compress.js?v=1986656815';
import{takeInventory,verdict}from'./inventory.js?v=1986656815';
import{EncryptedPdfError,NotAPdfError,PdfDocument}from'./shared/pdf-reader.js?v=1986656815';
import{wireFilePicker,readingLabel}from'./shared/file-picker.js?v=1986656815';
import{makeExample}from'./example.js?v=1986656815';
import{
bytes as humanBytes,change,count,dimensions,dpi,outName,share,
}from'./format.js?v=1986656815';
