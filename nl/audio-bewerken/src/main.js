...
import{phrase}from'./shared/phrases.js?v=ef00d58da2';
import{sizeText}from'./shared/format.js?v=ef00d58da2';
import{messageBox}from'./shared/message-box.js?v=ef00d58da2';
import{wireFilePicker}from'./shared/file-picker.js?v=ef00d58da2';
import{decodeAudio,UnreadableFile}from'./shared/audio-decode.js?v=ef00d58da2';
import{render,lengthAfter}from'./edit.js?v=ef00d58da2';
import{peak,dbToGain,gainToDb,normalizeGain}from'./effects.js?v=ef00d58da2';
import{writeWav,wavSize}from'./shared/wav.js?v=ef00d58da2';
import{drawWaveform}from'./waveform.js?v=ef00d58da2';
import{makeExample}from'./example.js?v=ef00d58da2';
