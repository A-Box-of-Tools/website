...
import{phrase,fill}from'./shared/phrases.js?v=079d7068b5';
import{decoderConfig,averageFps}from'./shared/webcodecs.js?v=079d7068b5';
import{sizeText,durationText}from'./shared/format.js?v=079d7068b5';
import{openInPlayer}from'./shared/media.js?v=079d7068b5';
import{messageBox}from'./shared/message-box.js?v=079d7068b5';
import{wireFilePicker}from'./shared/file-picker.js?v=079d7068b5';
import{demux,UnsupportedFile}from'./shared/mp4-reader.js?v=079d7068b5';
import{cropExact,grabFrame}from'./transcode.js?v=079d7068b5';
import{cropByRecording}from'./record.js?v=079d7068b5';
import{Cropper}from'./shared/cropper.js?v=079d7068b5';
import{hasWebCodecs,hasMediaRecorder,canDecode}from'./shared/video-support.js?v=079d7068b5';
import{makeExample}from'./example.js?v=079d7068b5';
