...
import{phrase,ltr}from'./shared/phrases.js?v=8b8b6c302e';
import{messageBox}from'./shared/message-box.js?v=8b8b6c302e';
import{wireFilePicker}from'./shared/file-picker.js?v=8b8b6c302e';
import{decodeGif,GifFormatError,playedDelay,totalDuration}from'./gif.js?v=8b8b6c302e';
import{GifCanvas,flatten,parseColour,patchPixels}from'./compose.js?v=8b8b6c302e';
import{
disposalLabel,encodePng,formatBytes,formatSeconds,
baseName,frameName,thumbnail,timingList,zipName,
}from'./frames.js?v=8b8b6c302e';
import{makeZip}from'./shared/zip.js?v=8b8b6c302e';
import{cellAt,sheetName,sheetPlan}from'./sheet.js?v=8b8b6c302e';
import{makeExample}from'./example.js?v=8b8b6c302e';
