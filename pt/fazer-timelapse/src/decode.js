...
import{FileWindow}from'./shared/mp4-reader.js?v=ae6fb8ae23';
import{decodeRuns}from'./plan.js?v=ae6fb8ae23';
import{drawScaled,frameCanvas}from'./shared/frame-canvas.js?v=ae6fb8ae23';
import{decoderConfig,settle}from'./shared/webcodecs.js?v=ae6fb8ae23';
import{throwIfAborted}from'./shared/errors.js?v=ae6fb8ae23';
class Sampler{
#times;
#canvas;
#write;
