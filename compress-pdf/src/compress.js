...
import{takeInventory}from'./inventory.js?v=3be8c4c8c2';
import{
decodeImage,findImages,reencode,replaceImage,SKIP,
}from'./images.js?v=3be8c4c8c2';
import{effectiveDpi,measurePlacements}from'./placements.js?v=3be8c4c8c2';
import{PdfDocument}from'./shared/pdf-reader.js?v=3be8c4c8c2';
import{stripMetadata,writeDocument}from'./shared/pdf-writer.js?v=3be8c4c8c2';
