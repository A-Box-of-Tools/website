...
import{drawPhoto}from'./example-photo.js?v=079d7068b5';
import{pickH264Codec}from'./video-support.js?v=079d7068b5';
import{Mp4Muxer}from'./mp4-muxer.js?v=079d7068b5';
const BREATH=24;
function turn(){
