...
import{isGoTo,namedDestinations,resolveDestination}from'./dests.js?v=7117203ba2';
import{count}from'./format.js?v=7117203ba2';
import{decodeText,normalizeRotation,readPages}from'./shared/pdf-pages.js?v=7117203ba2';
import{pruneOutline,readOutline,writeOutline}from'./outline.js?v=7117203ba2';
import{
isName,name,Name,PdfStream,Ref,
}from'./shared/pdf-objects.js?v=7117203ba2';
