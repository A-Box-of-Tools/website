/*
  ...
  This measures page visits. It is never given anything about your files: no
  image, no thumbnail, no filename, no dimension, no count. Nothing here reads
  the image queue, and there is no custom event in this file to carry it.
*/
